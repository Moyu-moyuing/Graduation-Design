<template>
  <div class="login-container">
    <el-form ref="loginForm" :model="loginForm" :rules="loginRules" class="login-form" auto-complete="on" label-position="left">
      ...
      <el-row>
        <el-button :loading="loading" type="primary" style="width:45%;margin-bottom:30px;" @click="handleLogin">登录</el-button>
        <el-button :loading="loading" type="warning" style="width:45%;margin-bottom:30px; margin-left: 45px;" @click="handleRegister">立即注册</el-button>
