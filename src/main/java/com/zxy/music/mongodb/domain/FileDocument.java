package com.zxy.music.mongodb.domain;
...
public class FileDocument {
    ...
    public boolean equals(Object o) {
        ...
        return size == that.size &&
                ...
                Objects.equals(gridfsId, that.gridfsId);
    }

    @Override
    public int hashCode() {
        int result = Objects.hash(id, name, size, uploadDate, md5, contentType, suffix, description, gridfsId);
